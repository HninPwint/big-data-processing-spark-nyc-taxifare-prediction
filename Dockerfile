...
# Configure Spark
ENV SPARK_OPTS="--driver-java-options=-Xms1024M --driver-java-options=-Xmx12288M --driver-java-options=-Dlog4j.logLevel=info --spark.executor.memory=8g --spark.driver.memory=8g" \
